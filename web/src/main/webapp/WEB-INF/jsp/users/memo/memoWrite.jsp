...
<jsp:include page="../../session_check.jsp" />   
      ...
      <section id="main-content">
          ...
          <form method="post" action="/users/memo/memoWrite" enctype="multipart/form-data" name="form1">
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> 한줄 메모 적기</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="icon_document_alt"></i>memo</li>
						<li><i class="fa fa-file-text-o"></i>메모하기</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <div class="panel-body">
       						  ...
       						  <hr>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="email" name="email" value="${vo.email }"  class="form-control round-input">
                                      </div>
                                  </div>
                           ...
                           <hr style="border: 2px solid #fff;">   
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input class="form-control" name="phone" value="${vo.phone }" type="text" >
                                      </div>
                                  </div>
                              ...
                              <section class="panel">
                                  ...
                                  <div class="panel-body">
                                      <div class="form">
                                         ...
                                         <input type="button" value="메모하기" class="btn btn-primary" id="memoBtn" >
                                      </div>
                                  </div>
                              </section>
                          </div>
