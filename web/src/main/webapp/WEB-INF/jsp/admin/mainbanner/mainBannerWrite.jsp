        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">메인 배너 상품 등록 코드 &nbsp; <%-- <span class="label pull-right bg-red"> ${currentId }</span> </h3> --%>
            ...
            <!-- form start -->
              ...
              <!-- /.box-body -->
               <form role="form2" method="post" action="/admin/mainBanner/register" enctype="multipart/form-data" >
                <div class="form-group">
                  <label for="categoryOneTitle">상품 번호</label>
                  
                   <input type="text" class="form-control"  name="proudct_Id"   id="proudct_Id" readonly="readonly">
                </div>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" id="mainBannerSubmitBtn">메인 배너로 등록</button>
