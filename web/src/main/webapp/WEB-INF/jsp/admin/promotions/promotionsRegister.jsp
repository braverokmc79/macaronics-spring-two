      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form action="/admin/promotions/insertPromotions" method="post" enctype="multipart/form-data" name="form1">
              <div class="box-body">
   
               <div class="form-group">
                  <label >제목 (마지막 등록된 이벤트가 메인에 표시됨)</label>	
            ...
            <button type="button" class="btn btn-primary" id="promotionsBtn">기획전 등록</button>   
