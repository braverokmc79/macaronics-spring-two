      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form action="/admin/promotions/promotionsUpdate" method="post" enctype="multipart/form-data" name="form1">
              <div class="box-body">
   
               <div class="form-group">
                  <label >제목 </label>	
   					<input type="text"  name="title" id="title"  value="${promotions.title }" class="form-control"  placeholder="제목" >  					
                </div>
                
                <div class="form-group">
   					<label>이미지  (1920 * 1280)</label>
   					<input type="file" name="files" id="files" class="form-control" >	
   					<input type="hidden" value="${promotions.img_url }" name="oldImg" > 
   					<input type="hidden" value="${promotions.idx }" name="idx" >	
                </div>
                
                <div class="form-gorup" style="margin-bottom: 10px;">
                <label >기존 이미지</label>	
                	<img src="/promotions/${promotions.img_url }" >
                </div>
        
               
               <div class="form-group">
   					<label>내용</label>		
                 <textarea class="form-control" name="content" id="content">${promotions.content }</textarea>
               </div>
    		 </div>
              <!-- /.box-body -->
            ...
            <button type="button" class="btn btn-primary" id="promotionsBtn">기획전 수정하기</button>   
  ...
  $(function () {
    ...
    // instance, using default configuration.
      ...
      //    extraPlugins : 'youtube',
         ...
         filebrowserImageUploadUrl: '/ckeditor/promotionsUpload?path=promotions'	
