      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form action="/admin/coupon/insertcoupon" method="post" enctype="multipart/form-data" name="form1">
              <div class="box-body">
   
               <div class="form-group">
                  <label >제목 (마지막 등록된 쿠폰이 메인에 표시됨)</label>	
            ...
            <button type="button" class="btn btn-primary" id="couponBtn">쿠폰 등록</button>   
